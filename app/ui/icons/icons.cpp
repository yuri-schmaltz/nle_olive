...
QIcon icon::TextStretch;
QIcon icon::TextKerning;
QIcon icon::TextLineHeight;
...
void icon::LoadAll(const QString& theme)
{
  ...
  TextStretch = Create(theme, "text-stretch");
  TextKerning = Create(theme, "text-kerning");
  TextLineHeight = Create(theme, "text-line-height");
